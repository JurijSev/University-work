...
DROP TABLE IF EXISTS efasmCaught;
DROP TABLE IF EXISTS efasmFishLocality;
DROP TABLE IF EXISTS efasmFishBaited;
DROP TABLE IF EXISTS efasmRodOwners;
DROP TABLE IF EXISTS efasmHistory;
DROP TABLE IF EXISTS efasmLocale;
DROP TABLE IF EXISTS efasmMember;
DROP TABLE IF EXISTS efasmFish;
DROP TABLE IF EXISTS efasmRods;
DROP TABLE IF EXISTS efasmBait;
...
INSERT INTO efasmMember VALUES(1,'Jurij Sevcenko',19,'Lithuamian','20 Butt road','london', 07737548239,20200326),
...
INSERT INTO efasmHistory VALUES(1,20200328,2103,'MonkLakes','Cyprinus carpio',4.3),
...
INSERT INTO efasmCaught (memberId,dateCaught,timeCaught,localityName,fishCaught,species,weightKG,baitUsed,fishingRodUsed) 
...
INSERT INTO efasmRods VALUES('Dlina','Poole',1.0,12),
...
INSERT INTO efasmRodOwners VALUES(1,'Shakespear'),
	(1,'Daiwa'),
	(2,'Furba'),	
	(3,'Donka'),
	(4,'Sigma'),
...
UPDATE efasmMember SET nationality='Lithuanian' WHERE memberId=1;

/*Ivan Sinitsin has moved to 31 Essex Hall Road in colchester, update it*/

UPDATE efasmMember SET address='31 Essex Hall Road', townCity='Colchester' WHERE name='Ivan Sinitsin';


/* SECTION 4 SINGLE TABLE QUERIES */


/* 1) What is the largest that the fish can grow to be? (by species) */

SELECT DISTINCT speciesName AS Species, maxSizeCM 
FROM efasmFish
...
/* 3) How many places are there that members can fish for carp at?  */

SELECT COUNT(DISTINCT localityName) AS number_Of_Places 
...
DROP TABLE efasmMember, efasmFish, efasmLocale, efasmBait, efasmRods, efasmCaught, efasmHistory, efasmRodOwners;
